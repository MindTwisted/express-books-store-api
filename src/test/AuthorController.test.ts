...
describe('authorsController', () => {
    ...
    describe(`GET ${AUTHORS_URL}`, () => {
        it('should response with 200 and authors limited by 50', done => {
            agent.get(AUTHORS_URL).end((err: any, res: any) => {
        ...
        it('should response with 200 and authors shifted by offset if offset is a valid integer', done => {
            agent.get(`${AUTHORS_URL}?offset=100`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
                res.body.body.data.authors.should.be.a('array').that.have.lengthOf(50);
                res.body.body.data.authors.should.each.have.property('id');
        ...
        it('should response with 200 and authors shifted by offset if offset is not a valid integer', done => {
            agent.get(`${AUTHORS_URL}?offset=100,2`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
                res.body.body.data.authors.should.be.a('array').that.have.lengthOf(50);
                res.body.body.data.authors.should.each.have.property('id');
        ...
        it('should response with 200 and authors not shifted by offset if offset is not a valid number', done => {
            agent.get(`${AUTHORS_URL}?offset=abc`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
                res.body.body.data.authors.should.be.a('array').that.have.lengthOf(50);
                res.body.body.data.authors.should.each.have.property('id');
        ...
        it('should response with 200 and authors filtered by search string', done => {
            ...
            agent.get(`${AUTHORS_URL}?search=${searchString}`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
    ...
    describe(`GET ${AUTHORS_URL}/:id`, () => {
        it('should response with 200 and author if author with provided id exists', done => {
            agent.get(`${AUTHORS_URL}/1`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
        ...
        it('should response with 404 if author with provided id does not exist', done => {
            agent.get(`${AUTHORS_URL}/999`).end((err: any, res: any) => {
        ...
        it('should response with 404 if author with provided id does not exist', done => {
            agent.get(`${AUTHORS_URL}/abc`).end((err: any, res: any) => {
                res.should.have.status(404);
                res.body.should.have.property('status').eql('failed');
    ...
    describe(`GET ${AUTHORS_URL}/:id/books`, () => {
        it('should response with 200 and books filtered by author id', done => {
            const authorId = 1;

            agent.get(`${AUTHORS_URL}/${authorId}/books`).end((err: any, res: any) => {
                res.should.have.status(200);
                res.body.should.have.property('status').eql('success');
        ...
        it('should response with 200 and books filtered by author id and shifted by offset', done => {
            const authorId = 1;

            agent.get(`${AUTHORS_URL}/${authorId}/books`).end((err: any, res: any) => {
                const fullLength = res.body.body.data.books.length;

                agent.get(`${AUTHORS_URL}/${authorId}/books?offset=1`).end((err: any, res: any) => {
                    res.should.have.status(200);
                    res.body.should.have.property('status').eql('success');
    ...
    describe(`POST ${AUTHORS_URL}`, () => {
        it('should response with 401 if auth token was not provided', done => {
            agent.post(AUTHORS_URL).end((err: any, res: any) => {
    ...
    describe(`PUT ${AUTHORS_URL}/:id`, () => {
        it('should response with 401 if auth token was not provided', done => {
            agent.put(`${AUTHORS_URL}/1`).end((err: any, res: any) => {
                res.should.have.status(401);
                res.body.should.have.property('status').eql('failed');
    ...
    describe(`DELETE ${AUTHORS_URL}/:id`, () => {
        it('should response with 401 if auth token was not provided', done => {
            agent.delete(`${AUTHORS_URL}/1`).end((err: any, res: any) => {
                res.should.have.status(401);
                res.body.should.have.property('status').eql('failed');
